...
class ProductCommentsDefaultModuleFrontController extends ModuleFrontController
{
	...
	protected function ajaxProcessAddComment()
	{
		...
		$is_comments_moderate = Configuration::get('PRODUCT_COMMENTS_MODERATE');
		$html = '';
		...
		if ($is_comments_moderate == 0 && $result) {
			...
			$html .= 	'<span class="circle"><img class="iavatar" title="" alt="" src="'.$site_url.'/modules/productcomments/img/user.png" /></span>';
