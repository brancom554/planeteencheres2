...
class smartbloghomelatestnews extends Module {
     ...
     public function install(){
                ...
                $id_lang = (int) Configuration::get('PS_LANG_DEFAULT');
                 if (!parent::install() 
				 || !$this->registerHook('displayHomeNews')
				 || !$this->registerHook('displayHomeNews2')
                 || !$this->registerHook('displayHomeNews3')
    	 	...
    	 	public function hookdisplayHomeNews($params) {
                ...
                else
                {
					//if (!$this->isCached('smartblog_latest_news.tpl', $this->getCacheId())){
							...
							if(empty($view_data['posts'])) return;
							$this->smarty->assign( array(
									  'view_data'     	 => $view_data['posts'],
									  'modules_dir'      =>  __PS_BASE_URI__.'modules/'
							));
					// }
					return $this->fetch('module:smartbloghomelatestnews/views/templates/front/smartblog_latest_news.tpl');
					//return $this->display(__FILE__, 'smartblog_latest_news.tpl', $this->getCacheId());
                }  
            }
			public function hookdisplayHomeNews2($params) {
                ...
                {
					//if (!$this->isCached('smartblog_latest_news2.tpl', $this->getCacheId())) {
							$view_data['posts'] = SmartBlogPost::GetPostLatestHome(Configuration::get('smartshowhomepost')); 
							if(empty($view_data['posts'])) return;
							$this->smarty->assign( array(
									  'view_data'     	 => $view_data['posts'],
					   ...
					   // }
					  return $this->fetch('module:smartbloghomelatestnews/views/templates/front/smartblog_latest_news2.tpl');
					  //return $this->display(__FILE__, 'smartblog_latest_news.tpl', $this->getCacheId());
                }  
            }

            public function hookdisplayHomeNews3($params) {
                ...
                {
					//if (!$this->isCached('smartblog_latest_news3.tpl', $this->getCacheId())){
						  $view_data['posts'] = SmartBlogPost::GetPostLatestHome(Configuration::get('smartshowhomepost')); 
						  if(empty($view_data['posts'])) return;
						  $this->smarty->assign( array(
									'view_data'        => $view_data['posts'],
					 ...
					 //}
					return $this->fetch('module:smartbloghomelatestnews/views/templates/front/smartblog_latest_news3.tpl');
					//return $this->display(__FILE__, 'smartblog_latest_news.tpl', $this->getCacheId());
                }  
            }
