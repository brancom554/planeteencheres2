          ...
          <div class="col-md-6 divide-right">
            <div class="row">
              <div class="col-md-6">
				...
				{else}
					<img class="product-image" src="{Context::getContext()->link->getImageLink($product.link_rewrite, $product.id_image, 'medium_default')|escape:'html':'UTF-8'}" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
				{/if}
              </div>
              <div class="col-md-6">
