		...
		{foreach from=$spproduct item=products name=mypLoop}
			<ul class="products_block row">
				{foreach from=$products item=product name=products}
					<li class="ajax_block_product product_block  col-xs-12 col-sm-6 col-md-{12/$itempage} {if $smarty.foreach.products.first}first_item{elseif $smarty.foreach.products.last}last_item{/if}">
