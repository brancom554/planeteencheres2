...
{if isset($list) && !empty($list)}
    {foreach from=$list item=items}
            ...
            <div class="moduletable  {$moduleclass_sfx|escape:'html':'UTF-8'} {$class_hook|escape:'html':'UTF-8'}">
				<div class="spmostviewed-heading clearfix">
                ...
                {if isset($_list) && $_list}
                    ...
                    <div id="{$tag_id|escape:'html':'UTF-8'}" class="sp-mostviewed sp-preload" 
										...
										<div class="product-description">												
											{if $items->params.display_name == 1}
											  {block name='product_name'}
												<h1 class="h3 product-title" itemprop="name"><a href="{$product.link}">{$product.name|truncate:$items->params.name_maxlength:'...'}</a></h1>
											  {/block}
											{/if}  
