...
{/foreach}
	...
	{cycle values='comparison_feature_odd,comparison_feature_even' assign='classname'}
<tr>
	<td  class="{$classname} comparison_infos">{l s='Average' d='Shop.Theme.Actions'}</td>
{foreach from=$list_ids_product item=id_product}
...
<tr>
	...
	<td  width="{$width}%" class="{$classname} comparison_infos" align="center" >
		...
		<a href="#" rel="#comments_{$id_product}" class="cluetip">{l s='view comments' d='Shop.Theme.Actions'}</a>
