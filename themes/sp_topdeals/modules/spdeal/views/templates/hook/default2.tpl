            ...
            {if isset($_list) && $_list}
                ...
                <div id="{$tag_id|escape:'html':'UTF-8'}" class="sp-deal sp-preload" >
					...
					{assign var="nb_rows" value=2}
                        ...
                        {if isset($product.specialPriceToDate)}
							...
							<article class="product-miniature js-product-miniature" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">		
                                <div class="product-container">
										<div class="left-block col-lg-6 col-md-5">
										...
										<div class="product-info right-block col-lg-6 col-md-7">
						...
						{if isset($count) && ($count % $nb_rows == 0 || $count == $count_item)}
							</div>
						{/if}
					   ...
					   var _timer = 0;
						...
						function CountDown(date, id) {
							...
							if (amount < 0 && $("#" + id).length) {
								...
								if (days != 0) {
									out += "<div class='time-item time-day'>" + "<div class='num-time'>" + days + "</div>" + "<div class='name-time'>" + ((days == 1) ? "{l s=' D : ' d='Shop.Theme.Actions'}" : "{l s=' D : ' d='Shop.Theme.Actions'}") + "</div>" + "</div> ";
								}
								if (hours != 0) {
									out += "<div class='time-item time-hour'>" + "<div class='num-time'>" + hours + "</div>" + "<div class='name-time'>" + ((hours == 1) ? "{l s=' H : ' d='Shop.Theme.Actions'}" : "{l s=' H : ' d='Shop.Theme.Actions'}") + "</div>" + "</div>";
								}
								out += "<div class='time-item time-min'>" + "<div class='num-time'>" + mins + "</div>" + "<div class='name-time'>" + ((mins == 1) ? "{l s=' M : ' d='Shop.Theme.Actions'}" : "{l s=' M : ' d='Shop.Theme.Actions'}") + "</div>" + "</div>";
								out += "<div class='time-item time-sec'>" + "<div class='num-time'>" + secs + "</div>" + "<div class='name-time'>" + ((secs == 1) ? "{l s=' S' d='Shop.Theme.Actions'}" : "{l s=' S' d='Shop.Theme.Actions'}") + "</div>" + "</div>";
