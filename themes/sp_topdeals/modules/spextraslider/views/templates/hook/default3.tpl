												...
												<div class="product-image">
													...
													<div class="button-container">
														{if $items->params.display_quickview}	
															<a href="#" class="quick-view" data-link-action="quickview" title = "{l s='Quick View' mod='spextraslider'}">
													    ...
													    {if $items->params.display_addtocart}
													      <div class="cart_content">
													        {if $sp_product.availability == 'available'}
													            <a href="#" class="ajax-add-to-cart product-btn cart-button" data-id-product="{$sp_product.id_product}" data-minimal-quantity="1" title = "{l s='Add to cart' mod='spextraslider'}">
													              <span class="text">{l s='Add to cart' mod='spextraslider'}</span>
													            </a>
													          ...
													          {else}
													            <span class="no-product cart-button" data-id-product="{$sp_product.id_product}" data-minimal-quantity="1" title = "{l s='Add to cart' mod='spextraslider'}">
													              <span class="text">{l s='Add to cart' mod='spextraslider'}</span>
													            </span>
													        {/if}
													      </div>
												...
												<div class="product-info">
													...
													{/if}
												  	...
												  	{if $sp_product.discount_type === 'percentage'}
													  	<span class="discount-percentage">{$sp_product.discount_percentage} <strong>{l s='OFF' mod='spextraslider'}</strong></span>
													{/if}
												</div>
											</div>
		                                </div>
