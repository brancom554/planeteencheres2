            ...
            <div class="moduletable  {$moduleclass_sfx|escape:'html':'UTF-8'}">
                ...
                <div id="{$tag_id|escape:'html':'UTF-8'}" class="sp-listing-tabs first-load"><!--<![endif]-->
                    <div class="ltabs-wrap">
                        <!--Begin Tabs-->
                        <div class="ltabs-tabs-container" data-delay="{$items->params.interval|escape:'html':'UTF-8'}" data-duration="{$items->params.duration|escape:'html':'UTF-8'}"
																						 
																							
                             data-effect="{$items->params.effect|escape:'html':'UTF-8'}" data-ajaxurl="{$urls.base_url|escape:'html':'UTF-8'}"
																			 
                             data-modid="{$items->id_splistingtabs|escape:'html':'UTF-8'}" data-hookname="{$hook_name}">
                            ...
                            {/if}
                            {include file="module:splistingtabs/views/templates/hook/default_tabs.tpl"}
                        </div>
                        <!-- End Tabs-->
                        ...
                        <div class="ltabs-items-container {$class_condition|escape:'html':'UTF-8'}">
                            {foreach $_list as $item}
                                ...
                                <div class="ltabs-items {$cls|escape:'html':'UTF-8'} {$cls2|escape:'html':'UTF-8'}">
                                    <div class="ltabs-items-inner product-listing {$class_ltabs|escape:'html':'UTF-8'} {$cls_animate|escape:'html':'UTF-8'}">
                                        {if !empty($child_items)}
                                            {include file="module:splistingtabs/views/templates/hook/default_items2.tpl"} 
                                        {else}
                                    ...
                                    {assign var="classloaded_2" value=($classloaded)?'All Ready':'View All'}
                                    {assign var="id_caterogy" value=($item['id_category'] == '*')?'all':$item['id_category']}
                                    <!--<div class="load-clear"></div>-->
                                    <div class="ltabs-loadmore ltabs-item ajax_block_product"
                                         ...
                                         data-ajaxurl="{$urls.base_url|escape:'html':'UTF-8'}"
                                        ...
                                        <div class="ltabs-loadmore-btn {$classloaded|escape:'html':'UTF-8'}"
                                            ...
                                            <!--<img class="add-loadmore"
                                                 src="{$urls.base_url|escape:'html':'UTF-8'}/modules/splistingtabs/views/img/add.png"/>-->
                                        </div>
                                    </div>
                                    {/if}
                                </div>
                ...
                {include file="module:splistingtabs/views/templates/hook/default_js.tpl"}

            </div>
        {/foreach}
    {else}
        {l s='Has no content to show! In Module SpListingtabs' d='Shop.Theme.Actions'}
    {/if}
{/if}
<!-- End SP Listing Tabs -->
