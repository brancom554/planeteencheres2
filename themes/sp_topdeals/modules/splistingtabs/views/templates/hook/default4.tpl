            ...
            <div class="moduletable  {$moduleclass_sfx|escape:'html':'UTF-8'}">
                ...
                <div id="{$tag_id|escape:'html':'UTF-8'}" class="sp-listing-tabs first-load"><!--<![endif]-->
                    <div class="ltabs-wrap">
                        ...
                        <div class="ltabs-items-container {$class_condition|escape:'html':'UTF-8'}  col-lg-9 col-xs-12">
                                ...
                                <div class="ltabs-items {$cls|escape:'html':'UTF-8'} {$cls2|escape:'html':'UTF-8'}">
                                    <div class="ltabs-items-inner product-listing {$class_ltabs|escape:'html':'UTF-8'} {$cls_animate|escape:'html':'UTF-8'}">
                                        {if !empty($child_items)}
                                            {include file="module:splistingtabs/views/templates/hook/default_items4.tpl"} 
                                        {else}
                        ...
                        <div class="box-banner col-lg-3 hidden-md-down"> 
                            {hook h='displayBanner18'}
                        </div>
