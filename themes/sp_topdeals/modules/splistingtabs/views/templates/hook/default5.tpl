                                ...
                                <div class="ltabs-items {$cls|escape:'html':'UTF-8'} {$cls2|escape:'html':'UTF-8'}">
                                    <div class="ltabs-items-inner product-listing {$class_ltabs|escape:'html':'UTF-8'} {$cls_animate|escape:'html':'UTF-8'}">
                                        {if !empty($child_items)}
                                            {include file="module:splistingtabs/views/templates/hook/default_items5.tpl"} 
                                        {else}
                                            <div class="ltabs-loading"></div>
                                        {/if}
                                    </div>

                                    <div class="box-banner hidden-md-down clearfix"> 
                                        {hook h='displayBanner19'}
                                        {hook h='displayBanner20'}
                                    </div>
